...
TableTools.BUTTONS = {
	...
	"copy": $.extend( {}, TableTools.buttonBase, {
		...
		"fnComplete": function(nButton, oConfig, flash, text) {
			var
				...
				plural = (len==1) ? "" : "s";
			this.fnInfo( '<h6>Tábla kimásolva</h6>'+
				'<p>'+len+' sor átmásolva vágólapra.</p>',
				1500
			);
		}
	} ),
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Nyomtatási előkép</h6><p>A böngészőbe épülő nyomtató használható a "+
		  "lap kinyomtatásához. Nyomjon 'Esc' billentyűt, ha végzett.</p>",
		"sMessage": null,
		"bShowAll": true,
